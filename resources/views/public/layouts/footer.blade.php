            ...
            {{--<div class="links-footer__wrapper">--}}
                {{--<ul class="footer-menu list1">--}}
                    ...
                    {{--<li class="footer-menu__item">--}}
                        {{--<a class="footer-menu__link" href="{{env('APP_URL')}}/page/o-nas">О компании</a>--}}
                    {{--</li>--}}
                    {{--<li class="footer-menu__item">--}}
                        {{--<a class="footer-menu__link" href="{{env('APP_URL')}}/news">Новости компании</a>--}}
                    {{--</li>--}}
                    {{--<li class="footer-menu__item">--}}
                        {{--<a class="footer-menu__link" href="{{env('APP_URL')}}/page/nashi-klienti">Наши клиенты</a>--}}
                    {{--</li>--}}
                    {{--<li class="footer-menu__item">--}}
                        {{--<a class="footer-menu__link" href="{{env('APP_URL')}}/page/otzivi-klientov">Отзывы и рекомендаци</a>--}}
                    {{--</li>--}}
                {{--</ul>--}}

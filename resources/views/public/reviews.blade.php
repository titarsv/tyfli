                    ...
                    <form action="" class="response-form ajax_form"
                        ...
                        <div class="row">
                            <div class="col-md-12 path-underline">
                                ...
                                <textarea class="response-form-text margin" placeholder="Вам понравилось обслуживание? Сообщите нам, что вы думаете" name="text" data-validate-required="Обязательное поле" data-title="Отзыв"></textarea>
                            </div>

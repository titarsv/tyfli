...
class ModulebannersController extends Controller
{
    ...
    public $module_name = 'banners';

    public function __construct(Request $request, Modulebanners $slideshow, Modules $modules) {
    ...
    public function index()
    {
        ...
        return view('admin.modules.banners')
            ->with('module', $module)
